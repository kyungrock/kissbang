...
# -*- coding: utf-8 -*-
"""
부산 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'junggu': {
        'name': '중구',
        'districts': [
            '시내 중심', '중앙동', '동광동', '대청동', '보수동', '부평동', '영주동'
        ],
        'description': '부산의 중심 지역으로, 자갈치시장과 국제시장이 있는 상업 중심지입니다.'
    },
    'seogu': {
        'name': '서구',
        'districts': [
            '시내 중심', '부용동', '아미동', '초장동', '충무동', '남부민동', '암남동'
        ],
        'description': '부산의 서쪽 지역으로, 부산항과 상업지역이 발달한 지역입니다.'
    },
    'donggu': {
        'name': '동구',
        'districts': [
            '시내 중심', '초량동', '수정동', '좌천동', '범일동', '범천동', '범일동'
        ],
        'description': '부산의 동쪽 지역으로, 부산역과 가까워 접근성이 뛰어납니다.'
    },
    'yeongdo': {
        'name': '영도',
        'districts': [
            '시내 중심', '영선동', '신선동', '봉래동', '청학동', '동삼동', '남항동'
        ],
        'description': '부산의 섬 지역으로, 태종대와 해안 관광지가 있는 지역입니다.'
    },
    'busanjin': {
        'name': '부산진',
        'districts': [
            '시내 중심', '범전동', '범천동', '전포동', '양정동', '개금동', '당감동'
        ],
        'description': '부산의 중심 지역으로, 서면과 상업지역이 발달한 지역입니다.'
    },
    'dongnae': {
        'name': '동래',
        'districts': [
            '시내 중심', '명륜동', '온천동', '사직동', '안락동', '낙민동', '복천동'
        ],
        'description': '부산의 동쪽 지역으로, 동래온천과 전통 문화가 있는 지역입니다.'
    },
    'namgu': {
        'name': '남구',
        'districts': [
            '시내 중심', '대연동', '용호동', '용당동', '문현동', '우암동', '감만동'
        ],
        'description': '부산의 남쪽 지역으로, 광안리 해수욕장과 주거지역이 있는 지역입니다.'
    },
    'bukgu': {
        'name': '북구',
        'districts': [
            '시내 중심', '구포동', '금곡동', '화명동', '덕천동', '만덕동', '삼락동'
        ],
        'description': '부산의 북쪽 지역으로, 주거지역과 산업단지가 발달한 지역입니다.'
    },
    'haeundae': {
        'name': '해운대',
        'districts': [
            '시내 중심', '우동', '중동', '좌동', '재송동', '반송동', '송정동'
        ],
        'description': '부산의 동쪽 해안 지역으로, 해운대 해수욕장과 관광지가 있는 지역입니다.'
    },
    'saha': {
        'name': '사하',
        'districts': [
            '시내 중심', '괴정동', '당리동', '하단동', '신평동', '장림동', '다대동'
        ],
        'description': '부산의 서남쪽 지역으로, 낙동강 하구와 주거지역이 있는 지역입니다.'
    },
    'geumjeong': {
        'name': '금정',
        'districts': [
            '시내 중심', '서동', '금사동', '부곡동', '장전동', '구서동', '선두구동'
        ],
        'description': '부산의 북동쪽 지역으로, 금정산과 대학가가 있는 지역입니다.'
    },
    'gangseo': {
        'name': '강서',
        'districts': [
            '대저동', '명지동', '가락동', '녹산동', '천가동', '가덕도동', '신호동'
        ],
        'description': '부산의 서쪽 지역으로, 김해공항과 가까운 지역입니다.'
    },
    'yeonje': {
        'name': '연제',
        'districts': [
            '시내 중심', '거제동', '연산동', '종합운동장', '거제동', '연산동', '수영동'
        ],
        'description': '부산의 중앙 지역으로, 종합운동장과 주거지역이 발달한 지역입니다.'
    },
    'suyeong': {
        'name': '수영',
        'districts': [
            '시내 중심', '망미동', '수영동', '광안동', '민락동', '남천동', '용호동'
        ],
        'description': '부산의 남쪽 해안 지역으로, 광안리 해수욕장과 관광지가 있는 지역입니다.'
    },
    'sasang': {
        'name': '사상',
        'districts': [
            '시내 중심', '삼락동', '모라동', '덕포동', '괘법동', '감전동', '주례동'
        ],
        'description': '부산의 서북쪽 지역으로, 사상역과 상업지역이 발달한 지역입니다.'
    },
    'gijang': {
        'name': '기장',
        'districts': [
            '기장읍', '장안읍', '정관읍', '일광면', '철마면', '송정동', '일광면'
        ],
        'description': '부산의 동쪽 해안 지역으로, 해운대와 인접한 해안 휴양지입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '해안 휴양지',
        'spots': [
            '해운대 해수욕장: 부산의 대표 해수욕장으로, 아름다운 해안과 다양한 엔터테인먼트 시설이 있습니다.',
            '광안리 해수욕장: 부산의 또 다른 대표 해수욕장으로, 광안대교 야경이 유명합니다.',
            '송도 해수욕장: 부산의 서쪽 해안에 위치한 해수욕장으로, 조용한 분위기를 즐길 수 있습니다.',
            '태종대: 영도에 위치한 해안 관광지로, 아름다운 절경을 감상할 수 있습니다.'
        ]
    },
    {
        'category': '문화 유적지',
        'spots': [
            '부산 국제시장: 부산의 대표 전통시장으로, 다양한 상품과 음식을 즐길 수 있습니다.',
            '자갈치시장: 부산의 대표 수산시장으로, 신선한 해산물을 구매할 수 있습니다.',
            '용두산공원: 부산의 대표 공원으로, 부산타워와 전망대가 있습니다.',
            '부산 박물관: 부산의 역사와 문화를 감상할 수 있는 박물관입니다.'
        ]
    },
    {
        'category': '쇼핑 및 엔터테인먼트',
        'spots': [
            '서면 상업지역: 부산의 대표 상업지역으로, 쇼핑과 식사를 즐길 수 있습니다.',
            '해운대 센트럴파크: 해운대에 위치한 대형 쇼핑몰로, 쇼핑과 엔터테인먼트를 즐길 수 있습니다.',
            '부산 CGV: 최신 영화를 감상할 수 있는 멀티플렉스입니다.',
            '부산 롯데시네마: 다양한 영화와 이벤트를 즐길 수 있는 영화관입니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '부산 해산물 전문 음식점',
        'foods': [
            '부산 회: 부산의 대표 음식으로, 신선한 회를 맛볼 수 있습니다.',
            '밀면: 부산의 대표 음식으로, 시원한 밀면을 맛볼 수 있습니다.',
            '돼지국밥: 부산의 대표 음식으로, 진한 국물이 일품입니다.',
            '물회: 부산의 대표 음식으로, 시원한 물회를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '부산 전통 음식',
        'foods': [
            '부산 떡볶이: 부산만의 특별한 떡볶이 맛을 즐길 수 있습니다.',
            '부산 순대: 전통 방식으로 만든 순대를 맛볼 수 있습니다.',
            '부산 어묵: 부산의 대표 간식으로, 다양한 어묵을 즐길 수 있습니다.',
            '부산 한정식: 전통 한정식을 맛볼 수 있는 전문점입니다.'
        ]
    },
    {
        'category': '부산 카페 및 디저트',
        'foods': [
            '해운대 해안가 카페: 해운대 해안을 조망하며 커피를 마실 수 있는 카페입니다.',
            '광안리 해안가 카페: 광안리 해안을 조망하며 디저트를 즐길 수 있는 카페입니다.',
            '서면 카페 거리: 다양한 카페에서 커피와 디저트를 즐길 수 있습니다.',
            '부산 전통찻집: 전통 차와 한과를 즐길 수 있는 찻집입니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    """소개글 생성"""
    if region_name == '부산':
        region_description = '영남권의 대표 도시로, 해운대와 광안리 등 해안 휴양지가 유명한 국제도시입니다.'
        display_name = ''
        title_prefix = '부산'
    else:
        region_key = {
            '중구': 'junggu', '서구': 'seogu', '동구': 'donggu', '영도': 'yeongdo',
            '부산진': 'busanjin', '동래': 'dongnae', '남구': 'namgu', '북구': 'bukgu',
            '해운대': 'haeundae', '사하': 'saha', '금정': 'geumjeong', '강서': 'gangseo',
            '연제': 'yeonje', '수영': 'suyeong', '사상': 'sasang', '기장': 'gijang'
        }.get(region_name, '')
        region_info = REGION_DISTRICTS.get(region_key, {})
        region_description = region_info.get('description', '부산 지역')
        display_name = region_name
        title_prefix = f'부산 {region_name}'
    ...
    if theme_name:
        ...
        return f"""            <h3>{theme_info['icon']} {title_prefix} {theme_info['name']} 소개</h3>
            ...
            <p>
              {title_prefix} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '부산'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        return f"""            <h3>🌊 {title_prefix} 마사지 소개</h3>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {region_description} {display_name if display_name else '부산'}에서 제공되는 전문 마사지 서비스입니다. {display_name if display_name else '부산'}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              {title_prefix} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '부산'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ {title_prefix} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>는 {display_name if display_name else '부산'}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '부산'}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ {title_prefix} 마사지의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {display_name if display_name else '부산'}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '부산'}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    ...
    if region_name == '부산':
        ...
        districts_html = '\n'.join([f'                <li><strong>{district}:</strong> 부산 {district}에는 전문 마사지 업체들이 위치해 있으며, 각 구별로 특색 있는 마사지 서비스를 제공합니다.</li>' for district in districts[:10]])
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 부산 {theme_display} 추천 행정구간</h4>
            <p>
              <strong>부산</strong>은 16개 구/군으로 구성되어 있으며, 각 구마다 전문 {theme_display} 업체들이 운영되고 있습니다. 부산의 주요 구별 {theme_display} 특색을 소개합니다.
            </p>
            <div class="info-highlight">
              <h4>🏛️ 부산 주요 구/군</h4>
              <ul>
{districts_html}
        ...
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 부산 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
def generate_tourism(region_name, theme_name=None):
    """관광 및 놀이 생성"""
    display_name = '부산' if region_name == '부산' else region_name
    title_prefix = '부산' if region_name == '부산' else f'부산 {region_name}'
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🎨 {title_prefix} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 부산의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 부산의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
{tourism_html.rstrip()}"""
        ...
        return f"""            <h4>🎨 {title_prefix} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 부산의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 부산의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🍽️ {title_prefix} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 부산의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 부산의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
{food_html.rstrip()}"""
        ...
        return f"""            <h4>🍽️ {title_prefix} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 부산의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 부산의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 {title_prefix} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']} 업체</strong>에서는 {display_name if display_name else '부산'}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 {title_prefix} 마사지 서비스 소개</h4>
            <p>
              <strong>{title_prefix} 마사지 업체</strong>에서는 {display_name if display_name else '부산'}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
...
def main():
    ...
    # 상세지역 목록
    detail_regions = ['junggu', 'seogu', 'donggu', 'yeongdo', 'busanjin', 'dongnae', 
                     'namgu', 'bukgu', 'haeundae', 'saha', 'geumjeong', 'gangseo', 
    ...
    # 1. 부산 전체 파일 업데이트
    print("=== 부산 전체 파일 업데이트 시작 ===")
    file_path = public_dir / 'busan.html'
    if file_path.exists():
        if update_file(file_path, '부산', None):
            updated_count += 1
    
    # 2. 부산 + 필터테마 파일들 업데이트
    print("\n=== 부산 + 필터테마 파일 업데이트 시작 ===")
    for theme in themes:
        file_path = public_dir / f'busan-{theme}.html'
        if file_path.exists():
            if update_file(file_path, '부산', theme):
                updated_count += 1
    
    # 3. 부산 + 상세지역 파일들 업데이트
    print("\n=== 부산 + 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'busan-{region}.html'
        if file_path.exists():
            region_name = region_name_map.get(region, region)
            if update_file(file_path, region_name, None):
                updated_count += 1
    
    # 4. 부산 + 상세지역 + 테마 파일들 업데이트
    print("\n=== 부산 + 상세지역 + 테마 파일 업데이트 시작 ===")
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'busan-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
