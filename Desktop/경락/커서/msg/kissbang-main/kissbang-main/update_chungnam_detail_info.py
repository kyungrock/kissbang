...
# -*- coding: utf-8 -*-
"""
충남 상세지역 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'cheonan': {
        'name': '천안',
        'districts': [
            '동남구 불당동', '동남구 신부동', '동남구 쌍용동', '동남구 백석동', 
            '동남구 성정동', '동남구 청수동', '서북구 두정동', '서북구 부성동',
            '서북구 성환읍', '서북구 직산읍', '서북구 입장면'
        ],
        'description': '수도권과 충청권을 연결하는 교통의 요지로, KTX 천안아산역과 천안역이 있어 접근성이 뛰어납니다.'
    },
    'asan': {
        'name': '아산',
        'districts': [
            '온양온천지구', '신창면', '염치읍', '배방읍', '탕정면', '선장면'
        ],
        'description': '온천이 유명한 지역으로, 힐링과 휴양을 동시에 즐길 수 있습니다.'
    },
    'gongju': {
        'name': '공주',
        'districts': [
            '시내 중심', '공주대 인근', '웅진동', '금성동', '옥룡동'
        ],
        'description': '백제 문화의 고도로, 전통과 현대가 어우러진 지역입니다.'
    },
    'boryeong': {
        'name': '보령',
        'districts': [
        ...
        'description': '대천해수욕장이 있는 해안 휴양지로, 여름철 휴가철에 특히 인기가 높습니다.'
    },
    'seosan': {
        'name': '서산',
        'districts': [
            '시내 중심', '해미읍', '고북면', '부석면', '지곡면'
        ],
        'description': '서해안의 아름다운 풍경과 함께하는 지역입니다.'
    },
    'nonsan': {
        'name': '논산',
        'districts': [
            '시내 중심', '강경읍', '연산면', '벌곡면', '부적면'
        ],
        'description': '논산시내 중심지로, 접근성이 좋은 지역입니다.'
    },
    'gyeryong': {
        'name': '계룡',
        'districts': [
        ...
        'description': '계룡산국립공원이 있는 자연 환경이 우수한 지역입니다.'
    },
    'dangjin': {
        'name': '당진',
        'districts': [
        ...
        'description': '산업단지와 가까워 출장객들에게 편리한 지역입니다.'
    },
    'geumsan': {
        'name': '금산',
        'districts': [
        ...
        'description': '인삼으로 유명한 지역으로, 전통적인 분위기가 있습니다.'
    },
    'buyeo': {
        'name': '부여',
        'districts': [
        ...
        'description': '백제 문화의 중심지로, 역사 유적지가 많은 지역입니다.'
    },
    'seocheon': {
        'name': '서천',
        'districts': [
        ...
        'description': '서해안의 해산물이 풍부한 지역입니다.'
    },
    'cheongyang': {
        'name': '청양',
        'districts': [
        ...
        'description': '조용한 주거지역으로, 편안한 분위기의 지역입니다.'
    },
    'hongseong': {
        'name': '홍성',
        'districts': [
        ...
        'description': '충남의 중심 지역으로, 접근성이 좋은 지역입니다.'
    },
    'yesan': {
        'name': '예산',
        'districts': [
        ...
        'description': '조용한 주거지역으로, 평화로운 분위기의 지역입니다.'
    },
    'taean': {
        'name': '태안',
        'districts': [
        ...
        'description': '태안해안국립공원이 있는 아름다운 해안 지역입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '해안 휴양지',
        'spots': [
            '대천해수욕장 (보령): 충남의 대표 해수욕장으로, 아름다운 백사장과 깨끗한 바다를 즐길 수 있습니다.',
            '만리포해수욕장 (태안): 아름다운 백사장과 함께하는 해안 휴양지로, 일몰을 감상할 수 있습니다.',
            '안면도 (태안): 태안해안국립공원 내의 아름다운 섬으로, 자연 속에서 힐링 타임을 보낼 수 있습니다.',
            '갯벌 체험장: 서해안의 갯벌에서 신선한 해산물을 직접 채취하고 요리해 먹을 수 있습니다.'
        ]
    },
    {
        'category': '역사 문화 유적지',
        'spots': [
            '공주 공산성: 백제의 역사를 느낄 수 있는 유적지로, 역사 탐방을 즐길 수 있습니다.',
            '부여 정림사지: 백제 문화의 중심지로, 문화 체험을 즐길 수 있습니다.',
            '아산 현충사: 이순신 장군을 기리는 사당으로, 역사 교육을 받을 수 있습니다.',
            '천안 독립기념관: 독립 운동의 역사를 배울 수 있는 교육 장소입니다.'
        ]
    },
    {
        'category': '자연 관광지',
        'spots': [
            '계룡산국립공원: 충남의 대표 산으로, 가벼운 등산을 즐기며 자연을 감상할 수 있습니다.',
            '태안해안국립공원: 아름다운 해안 절경을 자랑하는 국립공원으로, 해안 도로를 따라 드라이브를 즐길 수 있습니다.',
            '아산 외암마을: 전통 한옥 마을로, 전통 문화를 체험할 수 있습니다.',
            '천안 호수공원: 도심 속 자연 공원으로, 산책과 휴식을 즐길 수 있습니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '해산물 전문 음식점',
        'foods': [
            '보령 대천해수욕장 게장거리: 신선한 게장과 해산물을 맛볼 수 있습니다. 특히 꽃게장과 대게가 유명합니다.',
            '태안 만리포 해산물 식당: 신선한 회와 해산물 요리를 즐길 수 있습니다.',
            '서산 해미 해산물 시장: 신선한 해산물을 구매하고 바로 요리해 먹을 수 있습니다.',
            '당진 새우장어 거리: 신선한 새우와 장어 요리를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '충남 전통 음식',
        'foods': [
            '천안 불당동 막국수 거리: 충남의 대표 음식인 막국수를 맛볼 수 있습니다.',
            '아산 온양온천 순두부 마을: 부드러운 순두부를 맛볼 수 있습니다.',
            '공주 한정식 전문점: 백제 문화를 느낄 수 있는 전통 한정식을 즐길 수 있습니다.',
            '보령 대천 멍게비빔밥: 신선한 멍게를 이용한 비빔밥을 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '충남 카페 및 디저트',
        'foods': [
            '천안 불당동 카페 거리: 다양한 카페에서 커피와 디저트를 즐길 수 있습니다.',
            '아산 온천지구 힐링 카페: 온천 분위기를 느끼며 디저트를 즐길 수 있습니다.',
            '보령 해안가 카페: 바다 전망을 보며 커피를 마실 수 있습니다.',
            '태안 안면도 카페: 섬의 분위기를 느끼며 커피를 즐길 수 있습니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    ...
    region_description = region_info.get('description', '충남 지역')
    
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        intro = random.choice(theme_info['introductions'])
        return f"""            <h3>{theme_info['icon']} 충남 {region_name} {theme_info['name']} 소개</h3>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>는 {region_description} {intro} 충남 {region_name}에서는 이러한 전문 {theme_info['name']} 서비스를 제공하고 있으며, 각 지역마다 전문 {theme_info['name']} 업체가 운영되고 있습니다.
            </p>
            <p>
              충남 {region_name} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {region_name}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        return f"""            <h3>🌊 충남 {region_name} 마사지 소개</h3>
            <p>
              <strong>충남 {region_name} 마사지</strong>는 {region_description} {region_name}에서 제공되는 전문 마사지 서비스입니다. {region_name}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              충남 {region_name} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {region_name}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ 충남 {region_name} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>는 {region_name}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {region_name}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ 충남 {region_name} 마사지의 특징과 내용</h4>
            <p>
              <strong>충남 {region_name} 마사지</strong>는 {region_name}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {region_name}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    ...
    return f"""            <h4>🗺️ 충남 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>🎨 충남 {region_name} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>를 받은 후에는 충남의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 충남의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>

{tourism_html.rstrip()}"""
    else:
        return f"""            <h4>🎨 충남 {region_name} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>충남 {region_name} 마사지</strong>를 받은 후에는 충남의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 충남의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>🍽️ 충남 {region_name} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>를 받은 후에는 충남의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 충남의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>

{food_html.rstrip()}"""
    else:
        return f"""            <h4>🍽️ 충남 {region_name} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>충남 {region_name} 마사지</strong>를 받은 후에는 충남의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 충남의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
def generate_reviews(region_name, theme_name=None):
    ...
    if theme_name and theme_name in THEME_INFO:
        ...
        reviews_html = ''
        for i in range(8):
            review_text = random.choice(theme_reviews) if theme_reviews else f'{region_name}에서 {theme_display}를 받으니 정말 만족스러웠어요.'
...
"""
        ...
        for i in range(8):
            reviews_html += f"""              <div class="review-story">
                <h6>✨ "{review_titles[i]}" - {review_names[i]}</h6>
                <p>
                  "{region_name}에서 {theme_display}를 받으니 {review_details[i]}"
                </p>
              </div>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>💬 충남 {region_name} {theme_info['name']} 실제 고객 후기</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>를 실제로 이용하신 고객님들의 생생한 후기와 특별한 사연들을 소개합니다. {region_name}에서 {theme_info['name']}를 받으신 분들의 솔직한 경험담을 통해 더욱 신뢰할 수 있는 정보를 제공합니다.
            </p>
            <div class="review-stories">
{reviews_html.rstrip()}
            </div>"""
    else:
        return f"""            <h4>💬 충남 {region_name} 마사지 실제 고객 후기</h4>
            <p>
              <strong>충남 {region_name} 마사지</strong>를 실제로 이용하신 고객님들의 생생한 후기와 특별한 사연들을 소개합니다. {region_name}에서 마사지를 받으신 분들의 솔직한 경험담을 통해 더욱 신뢰할 수 있는 정보를 제공합니다.
            </p>
            <div class="review-stories">
{reviews_html.rstrip()}
            </div>"""
...
def generate_benefits(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>💎 충남 {region_name} {theme_info['name']} 받으면 좋은 점</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']}</strong>를 받으면 다양한 긍정적인 효과를 경험할 수 있습니다. {theme_info['name']}의 특별한 기법으로 전신 건강에도 많은 도움이 됩니다.
            </p>
            <div class="info-highlight">
              <h4>🏥 신체적 건강 효과</h4>
              <ul>
{benefits_html}
        ...
        return f"""            <h4>💎 충남 {region_name} 마사지 받으면 좋은 점</h4>
            <p>
              <strong>충남 {region_name} 마사지</strong>를 받으면 다양한 긍정적인 효과를 경험할 수 있습니다. 마사지의 특별한 기법으로 전신 건강에도 많은 도움이 됩니다.
            </p>
            <div class="info-highlight">
              <h4>🏥 신체적 건강 효과</h4>
              <ul>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 충남 {region_name} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>충남 {region_name} {theme_info['name']} 업체</strong>에서는 {region_name}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
              <h4>🌟 충남 {region_name} {theme_info['name']} 업체 제공 서비스</h4>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 충남 {region_name} 마사지 서비스 소개</h4>
            <p>
              <strong>충남 {region_name} 마사지 업체</strong>에서는 {region_name}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
              <h4>🌟 충남 {region_name} 마사지 업체 제공 서비스</h4>
              <div class="service-grid">
{services_html}
              </div>
              <div class="service-details">
...
def main():
    ...
    # 상세지역 파일들 (테마 없음)
    detail_regions = ['cheonan', 'asan', 'gongju', 'boryeong', 'seosan', 'nonsan', 
    ...
    # 상세지역 파일들 업데이트 (테마 없음)
    print("=== 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'chungnam-{region}.html'
        if file_path.exists():
    ...
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'chungnam-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
