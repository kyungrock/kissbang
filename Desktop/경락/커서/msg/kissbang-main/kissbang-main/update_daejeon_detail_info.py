...
# -*- coding: utf-8 -*-
"""
대전 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'donggu': {
        'name': '동구',
        'districts': [
            '시내 중심', '용운동', '삼성동', '대별동', '이사동', '대성동', '자양동'
        ],
        'description': '대전의 동쪽 지역으로, 대전역과 가까워 접근성이 뛰어납니다.'
    },
    'junggu': {
        'name': '중구',
        'districts': [
            '시내 중심', '은행동', '대흥동', '목동', '선화동', '유천동', '산성동'
        ],
        'description': '대전의 중심 지역으로, 상업지역과 주거지역이 어우러진 지역입니다.'
    },
    'seogu': {
        'name': '서구',
        'districts': [
            '시내 중심', '둔산동', '용문동', '탄방동', '관저동', '도마동', '정림동'
        ],
        'description': '대전의 서쪽 지역으로, 신도시와 주거지역이 발달한 지역입니다.'
    },
    'yuseong': {
        'name': '유성',
        'districts': [
            '시내 중심', '봉명동', '구암동', '노은동', '관평동', '원신흥동', '대정동'
        ],
        'description': '대전의 북쪽 지역으로, 대덕연구개발특구와 대학가가 있는 지역입니다.'
    },
    'daedeok': {
        'name': '대덕',
        'districts': [
            '시내 중심', '오정동', '신대동', '비래동', '석봉동', '송촌동', '회덕동'
        ],
        'description': '대전의 남동쪽 지역으로, 산업단지와 주거지역이 조화를 이루는 지역입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '문화 유적지',
        'spots': [
            '대전 국립중앙과학관: 과학과 기술을 체험할 수 있는 대형 과학관입니다.',
            '대전 예술의전당: 다양한 공연과 전시를 즐길 수 있는 문화 공간입니다.',
            '한밭수목원: 도심 속 자연 공원으로, 산책과 휴식을 즐길 수 있습니다.',
            '대전시립미술관: 현대 미술 작품을 감상할 수 있는 미술관입니다.'
        ]
    },
    {
        'category': '자연 관광지',
        'spots': [
            '계룡산국립공원: 대전 인근의 아름다운 산으로, 등산과 자연 감상을 즐길 수 있습니다.',
            '대전 둔산대공원: 도심 속 대형 공원으로, 산책과 운동을 즐길 수 있습니다.',
            '유성온천: 온천과 힐링을 동시에 즐길 수 있는 휴양지입니다.',
            '대전 갑천: 도심을 흐르는 강으로, 강변 산책로가 잘 조성되어 있습니다.'
        ]
    },
    {
        'category': '쇼핑 및 엔터테인먼트',
        'spots': [
            '대전 둔산타워: 대전의 랜드마크로, 전망대와 쇼핑몰이 있습니다.',
            '대전 현대프리미엄아울렛: 다양한 브랜드를 한 곳에서 쇼핑할 수 있습니다.',
            '대전 롯데시네마: 최신 영화를 감상할 수 있는 멀티플렉스입니다.',
            '대전 CGV: 다양한 영화와 이벤트를 즐길 수 있는 영화관입니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '대전 전통 음식',
        'foods': [
            '대전 칼국수: 대전의 대표 음식으로, 시원한 국물과 쫄깃한 면이 일품입니다.',
            '대전 떡볶이: 대전만의 특별한 떡볶이 맛을 즐길 수 있습니다.',
            '대전 순대: 전통 방식으로 만든 순대를 맛볼 수 있습니다.',
            '대전 닭갈비: 대전의 유명한 닭갈비 거리에서 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '대전 카페 및 디저트',
        'foods': [
            '대전 둔산동 카페 거리: 다양한 카페에서 커피와 디저트를 즐길 수 있습니다.',
            '대전 유성 카페: 대학가 근처의 트렌디한 카페들을 즐길 수 있습니다.',
            '대전 중구 전통찻집: 전통 차와 한과를 즐길 수 있는 찻집입니다.',
            '대전 디저트 카페: 다양한 디저트와 브런치를 즐길 수 있는 카페입니다.'
        ]
    },
    {
        'category': '대전 맛집',
        'foods': [
            '대전 한정식 전문점: 전통 한정식을 맛볼 수 있는 전문점입니다.',
            '대전 회 전문점: 신선한 회와 해산물을 즐길 수 있습니다.',
            '대전 고기집: 대전의 유명한 고기집에서 맛있는 고기를 즐길 수 있습니다.',
            '대전 파스타 전문점: 다양한 파스타와 이탈리안 요리를 즐길 수 있습니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    """소개글 생성"""
    if region_name == '대전':
        region_description = '충청권의 중심 도시로, 교통의 요지이자 경제 중심지입니다.'
        display_name = ''
        title_prefix = '대전'
    else:
        region_key = {
            '동구': 'donggu', '중구': 'junggu', '서구': 'seogu', 
            '유성': 'yuseong', '대덕': 'daedeok'
        }.get(region_name, '')
        region_info = REGION_DISTRICTS.get(region_key, {})
        region_description = region_info.get('description', '대전 지역')
        display_name = region_name
        title_prefix = f'대전 {region_name}'
    ...
    if theme_name:
        ...
        return f"""            <h3>{theme_info['icon']} {title_prefix} {theme_info['name']} 소개</h3>
            ...
            <p>
              {title_prefix} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '대전'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        return f"""            <h3>🏙️ {title_prefix} 마사지 소개</h3>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {region_description} {display_name if display_name else '대전'}에서 제공되는 전문 마사지 서비스입니다. {display_name if display_name else '대전'}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              {title_prefix} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '대전'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ {title_prefix} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>는 {display_name if display_name else '대전'}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '대전'}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ {title_prefix} 마사지의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {display_name if display_name else '대전'}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '대전'}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    """행정구간 생성"""
    display_name = '대전' if region_name == '대전' else region_name
    
    if region_name == '대전':
        # 대전 전체인 경우 구 정보 제공
        districts = ['동구', '중구', '서구', '유성구', '대덕구']
        districts_html = '\n'.join([f'                <li><strong>{district}:</strong> 대전 {district}에는 전문 마사지 업체들이 위치해 있으며, 각 구별로 특색 있는 마사지 서비스를 제공합니다.</li>' for district in districts])
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 대전 {theme_display} 추천 행정구간</h4>
            <p>
              <strong>대전</strong>은 5개 구로 구성되어 있으며, 각 구마다 전문 {theme_display} 업체들이 운영되고 있습니다. 대전의 주요 구별 {theme_display} 특색을 소개합니다.
            </p>
            <div class="info-highlight">
              <h4>🏛️ 대전 주요 구</h4>
              <ul>
{districts_html}
        ...
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 대전 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>🎨 대전 {display_name} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>대전 {display_name} {theme_info['name']}</strong>를 받은 후에는 대전의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 대전의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>

{tourism_html.rstrip()}"""
    else:
        return f"""            <h4>🎨 대전 {display_name} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>대전 {display_name} 마사지</strong>를 받은 후에는 대전의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 대전의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>🍽️ 대전 {display_name} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>대전 {display_name} {theme_info['name']}</strong>를 받은 후에는 대전의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 대전의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>

{food_html.rstrip()}"""
    else:
        return f"""            <h4>🍽️ 대전 {display_name} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>대전 {display_name} 마사지</strong>를 받은 후에는 대전의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 대전의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
"""
    ...
    if theme_name:
        theme_info = THEME_INFO[theme_name]
        return f"""            <h4>💬 대전 {display_name} {theme_info['name']} 실제 고객 후기</h4>
            <p>
              <strong>대전 {display_name} {theme_info['name']}</strong>를 실제로 이용하신 고객님들의 생생한 후기와 특별한 사연들을 소개합니다. {display_name}에서 {theme_info['name']}를 받으신 분들의 솔직한 경험담을 통해 더욱 신뢰할 수 있는 정보를 제공합니다.
            </p>
            <div class="review-stories">
{reviews_html.rstrip()}
            </div>"""
    else:
        return f"""            <h4>💬 대전 {display_name} 마사지 실제 고객 후기</h4>
            <p>
              <strong>대전 {display_name} 마사지</strong>를 실제로 이용하신 고객님들의 생생한 후기와 특별한 사연들을 소개합니다. {display_name}에서 마사지를 받으신 분들의 솔직한 경험담을 통해 더욱 신뢰할 수 있는 정보를 제공합니다.
            </p>
            <div class="review-stories">
{reviews_html.rstrip()}
            </div>"""
...
def generate_benefits(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>💎 대전 {display_name} {theme_info['name']} 받으면 좋은 점</h4>
            <p>
              <strong>대전 {display_name} {theme_info['name']}</strong>를 받으면 다양한 긍정적인 효과를 경험할 수 있습니다. {theme_info['name']}의 특별한 기법으로 전신 건강에도 많은 도움이 됩니다.
            </p>
            <div class="info-highlight">
              <h4>🏥 신체적 건강 효과</h4>
              <ul>
{benefits_html}
        ...
        return f"""            <h4>💎 대전 {display_name} 마사지 받으면 좋은 점</h4>
            <p>
              <strong>대전 {display_name} 마사지</strong>를 받으면 다양한 긍정적인 효과를 경험할 수 있습니다. 마사지의 특별한 기법으로 전신 건강에도 많은 도움이 됩니다.
            </p>
            <div class="info-highlight">
              <h4>🏥 신체적 건강 효과</h4>
              <ul>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 대전 {display_name} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>대전 {display_name} {theme_info['name']} 업체</strong>에서는 {display_name}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
              <h4>🌟 대전 {display_name} {theme_info['name']} 업체 제공 서비스</h4>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 대전 {display_name} 마사지 서비스 소개</h4>
            <p>
              <strong>대전 {display_name} 마사지 업체</strong>에서는 {display_name}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
              <h4>🌟 대전 {display_name} 마사지 업체 제공 서비스</h4>
              <div class="service-grid">
{services_html}
              </div>
              <div class="service-details">
...
def main():
    ...
    # 상세지역 목록
    detail_regions = ['donggu', 'junggu', 'seogu', 'yuseong', 'daedeok']
    ...
    # 1. 대전 전체 파일 업데이트
    print("=== 대전 전체 파일 업데이트 시작 ===")
    file_path = public_dir / 'daejeon.html'
    if file_path.exists():
        if update_file(file_path, '대전', None):
            updated_count += 1
    
    # 2. 대전 + 필터테마 파일들 업데이트
    print("\n=== 대전 + 필터테마 파일 업데이트 시작 ===")
    for theme in themes:
        file_path = public_dir / f'daejeon-{theme}.html'
        if file_path.exists():
            if update_file(file_path, '대전', theme):
                updated_count += 1
    
    # 3. 대전 + 상세지역 파일들 업데이트
    print("\n=== 대전 + 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'daejeon-{region}.html'
        if file_path.exists():
            region_name = region_name_map.get(region, region)
            if update_file(file_path, region_name, None):
                updated_count += 1
    
    # 4. 대전 + 상세지역 + 테마 파일들 업데이트
    print("\n=== 대전 + 상세지역 + 테마 파일 업데이트 시작 ===")
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'daejeon-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
