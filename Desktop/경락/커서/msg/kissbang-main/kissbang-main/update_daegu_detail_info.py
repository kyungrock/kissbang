...
# -*- coding: utf-8 -*-
"""
대구 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'junggu': {
        'name': '중구',
        'districts': [
            '시내 중심', '동성로', '계산동', '동인동', '삼덕동', '성내동', '대신동'
        ],
        'description': '대구의 중심 지역으로, 동성로와 상업지역이 발달한 지역입니다.'
    },
    'donggu': {
        'name': '동구',
        'districts': [
            '시내 중심', '신암동', '용계동', '효목동', '도동', '불로동', '지저동'
        ],
        'description': '대구의 동쪽 지역으로, 대구역과 가까워 접근성이 뛰어납니다.'
    },
    'seogu': {
        'name': '서구',
        'districts': [
            '시내 중심', '내당동', '비산동', '평리동', '원대동', '이현동', '중리동'
        ],
        'description': '대구의 서쪽 지역으로, 주거지역과 상업지역이 어우러진 지역입니다.'
    },
    'namgu': {
        'name': '남구',
        'districts': [
            '시내 중심', '대명동', '봉덕동', '이천동', '수성못', '중동', '신천동'
        ],
        'description': '대구의 남쪽 지역으로, 수성못과 대학가가 있는 지역입니다.'
    },
    'bukgu': {
        'name': '북구',
        'districts': [
            '시내 중심', '태전동', '관음동', '읍내동', '산격동', '복현동', '검단동'
        ],
        'description': '대구의 북쪽 지역으로, 주거지역과 산업단지가 발달한 지역입니다.'
    },
    'suseong': {
        'name': '수성구',
        'districts': [
            '시내 중심', '범어동', '만촌동', '황금동', '중동', '지산동', '범물동'
        ],
        'description': '대구의 동남쪽 지역으로, 수성못과 고급 주거지역이 있는 지역입니다.'
    },
    'dalseo': {
        'name': '달서구',
        'districts': [
            '시내 중심', '성서동', '용산동', '이곡동', '장기동', '월성동', '진천동'
        ],
        'description': '대구의 서남쪽 지역으로, 신도시와 주거지역이 발달한 지역입니다.'
    },
    'dalsung': {
        'name': '달성군',
        'districts': [
            '화원읍', '논공읍', '다사읍', '옥포읍', '현풍읍', '유가면', '구지면'
        ],
        'description': '대구의 서쪽 지역으로, 농업과 주거지역이 발달한 지역입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '문화 유적지',
        'spots': [
            '대구 동성로: 대구의 대표 상업지역으로, 쇼핑과 식사를 즐길 수 있습니다.',
            '대구 수성못: 대구의 대표 공원으로, 산책과 휴식을 즐길 수 있습니다.',
            '대구 팔공산: 대구의 대표 산으로, 등산과 자연 감상을 즐길 수 있습니다.',
            '대구 근대역사관: 대구의 근대 문화유산을 감상할 수 있는 박물관입니다.'
        ]
    },
    {
        'category': '자연 관광지',
        'spots': [
            '팔공산: 대구의 대표 산으로, 등산로와 전망대가 잘 조성되어 있습니다.',
            '수성못: 도심 속 호수로, 산책로와 자전거 도로가 있습니다.',
            '대구 앞산공원: 대구의 대표 공원으로, 등산과 자연 감상을 즐길 수 있습니다.',
            '대구 달성공원: 대구의 대표 공원으로, 산책과 휴식을 즐길 수 있습니다.'
        ]
    },
    {
        'category': '쇼핑 및 엔터테인먼트',
        'spots': [
            '동성로: 대구의 대표 상업지역으로, 쇼핑과 식사를 즐길 수 있습니다.',
            '대구 CGV: 최신 영화를 감상할 수 있는 멀티플렉스입니다.',
            '대구 롯데시네마: 다양한 영화와 이벤트를 즐길 수 있는 영화관입니다.',
            '대구 대형마트: 생활용품과 식품을 구매할 수 있는 대형마트입니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '대구 전통 음식',
        'foods': [
            '대구 막창: 대구의 대표 음식으로, 매콤한 막창을 맛볼 수 있습니다.',
            '대구 냉면: 대구의 대표 음식으로, 시원한 냉면을 맛볼 수 있습니다.',
            '대구 떡볶이: 대구만의 특별한 떡볶이 맛을 즐길 수 있습니다.',
            '대구 순대: 전통 방식으로 만든 순대를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '대구 카페 및 디저트',
        'foods': [
            '대구 동성로 카페 거리: 다양한 카페에서 커피와 디저트를 즐길 수 있습니다.',
            '대구 수성못 카페: 수성못을 조망하며 커피를 마실 수 있는 카페입니다.',
            '대구 전통찻집: 전통 차와 한과를 즐길 수 있는 찻집입니다.',
            '대구 디저트 카페: 다양한 디저트와 브런치를 즐길 수 있는 카페입니다.'
        ]
    },
    {
        'category': '대구 맛집',
        'foods': [
            '대구 한정식 전문점: 전통 한정식을 맛볼 수 있는 전문점입니다.',
            '대구 회 전문점: 신선한 회와 해산물을 즐길 수 있습니다.',
            '대구 고기집: 대구의 유명한 고기집에서 맛있는 고기를 즐길 수 있습니다.',
            '대구 파스타 전문점: 다양한 파스타와 이탈리안 요리를 즐길 수 있습니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    """소개글 생성"""
    if region_name == '대구':
        region_description = '영남권의 중심 도시로, 교통의 요지이자 경제 중심지입니다.'
        display_name = ''
        title_prefix = '대구'
    else:
        region_key = {
            '중구': 'junggu', '동구': 'donggu', '서구': 'seogu', '남구': 'namgu', 
            '북구': 'bukgu', '수성구': 'suseong', '달서구': 'dalseo', '달성군': 'dalsung'
        }.get(region_name, '')
        region_info = REGION_DISTRICTS.get(region_key, {})
        region_description = region_info.get('description', '대구 지역')
        display_name = region_name
        title_prefix = f'대구 {region_name}'
    ...
    if theme_name:
        ...
        return f"""            <h3>{theme_info['icon']} {title_prefix} {theme_info['name']} 소개</h3>
            ...
            <p>
              {title_prefix} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '대구'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        return f"""            <h3>🏙️ {title_prefix} 마사지 소개</h3>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {region_description} {display_name if display_name else '대구'}에서 제공되는 전문 마사지 서비스입니다. {display_name if display_name else '대구'}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              {title_prefix} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '대구'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ {title_prefix} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>는 {display_name if display_name else '대구'}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '대구'}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ {title_prefix} 마사지의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {display_name if display_name else '대구'}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '대구'}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    ...
    if region_name == '대구':
        ...
        districts_html = '\n'.join([f'                <li><strong>{district}:</strong> 대구 {district}에는 전문 마사지 업체들이 위치해 있으며, 각 구별로 특색 있는 마사지 서비스를 제공합니다.</li>' for district in districts])
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 대구 {theme_display} 추천 행정구간</h4>
            <p>
              <strong>대구</strong>은 8개 구/군으로 구성되어 있으며, 각 구마다 전문 {theme_display} 업체들이 운영되고 있습니다. 대구의 주요 구별 {theme_display} 특색을 소개합니다.
            </p>
            <div class="info-highlight">
              <h4>🏛️ 대구 주요 구/군</h4>
              <ul>
{districts_html}
        ...
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 대구 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
def generate_tourism(region_name, theme_name=None):
    """관광 및 놀이 생성"""
    display_name = '대구' if region_name == '대구' else region_name
    title_prefix = '대구' if region_name == '대구' else f'대구 {region_name}'
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🎨 {title_prefix} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 대구의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 대구의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
{tourism_html.rstrip()}"""
        ...
        return f"""            <h4>🎨 {title_prefix} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 대구의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 대구의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🍽️ {title_prefix} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 대구의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 대구의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
{food_html.rstrip()}"""
        ...
        return f"""            <h4>🍽️ {title_prefix} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 대구의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 대구의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 {title_prefix} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']} 업체</strong>에서는 {display_name if display_name else '대구'}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 {title_prefix} 마사지 서비스 소개</h4>
            <p>
              <strong>{title_prefix} 마사지 업체</strong>에서는 {display_name if display_name else '대구'}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
...
def main():
    ...
    # 상세지역 목록
    detail_regions = ['junggu', 'donggu', 'seogu', 'namgu', 'bukgu', 'suseong', 'dalseo', 'dalsung']
    ...
    # 1. 대구 전체 파일 업데이트
    print("=== 대구 전체 파일 업데이트 시작 ===")
    file_path = public_dir / 'daegu.html'
    if file_path.exists():
        if update_file(file_path, '대구', None):
            updated_count += 1
    
    # 2. 대구 + 필터테마 파일들 업데이트
    print("\n=== 대구 + 필터테마 파일 업데이트 시작 ===")
    for theme in themes:
        file_path = public_dir / f'daegu-{theme}.html'
        if file_path.exists():
            if update_file(file_path, '대구', theme):
                updated_count += 1
    
    # 3. 대구 + 상세지역 파일들 업데이트
    print("\n=== 대구 + 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'daegu-{region}.html'
        if file_path.exists():
            region_name = region_name_map.get(region, region)
            if update_file(file_path, region_name, None):
                updated_count += 1
    
    # 4. 대구 + 상세지역 + 테마 파일들 업데이트
    print("\n=== 대구 + 상세지역 + 테마 파일 업데이트 시작 ===")
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'daegu-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
