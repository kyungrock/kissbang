...
# -*- coding: utf-8 -*-
"""
전북 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'jeonju': {
        'name': '전주',
        'districts': [
            '완산구 중앙동', '완산구 풍남동', '완산구 노송동', '완산구 완산동', '완산구 동서학동',
            '덕진구 송천동', '덕진구 금암동', '덕진구 덕진동', '덕진구 인후동', '덕진구 삼천동'
        ],
        'description': '전북의 중심 도시로, 한옥마을과 전통 문화가 살아있는 지역입니다.'
    },
    'gunsan': {
        'name': '군산',
        'districts': [
            '시내 중심', '옥도면', '옥서면', '회현면', '임피면'
        ],
        'description': '서해안의 항구 도시로, 근대 문화유산이 많은 지역입니다.'
    },
    'iksan': {
        'name': '익산',
        'districts': [
            '시내 중심', '함열읍', '오산면', '황등면', '여산면'
        ],
        'description': '백제 문화의 중심지로, 미륵사지가 있는 역사 도시입니다.'
    },
    'jeongeup': {
        'name': '정읍',
        'districts': [
            '시내 중심', '신태인읍', '입암면', '소성면', '고부면'
        ],
        'description': '내장산국립공원이 있는 자연 환경이 우수한 지역입니다.'
    },
    'namwon': {
        'name': '남원',
        'districts': [
            '시내 중심', '주천면', '산동면', '이백면', '아영면'
        ],
        'description': '춘향전의 배경이 된 지역으로, 전통 문화가 살아있는 도시입니다.'
    },
    'gimje': {
        'name': '김제',
        'districts': [
            '시내 중심', '만경읍', '황산면', '금산면', '용지면'
        ],
        'description': '벽골제가 있는 농업 중심 도시입니다.'
    },
    'wanju': {
        'name': '완주',
        'districts': [
        ...
        'description': '전주와 인접한 지역으로, 접근성이 좋은 지역입니다.'
    },
    'jinan': {
        'name': '진안',
        'districts': [
        ...
        'description': '마이산이 있는 자연 환경이 우수한 지역입니다.'
    },
    'muju': {
        'name': '무주',
        'districts': [
        ...
        'description': '덕유산국립공원이 있는 스키 리조트 지역입니다.'
    },
    'jangsu': {
        'name': '장수',
        'districts': [
        ...
        'description': '덕유산과 인접한 자연 환경이 우수한 지역입니다.'
    },
    'imsil': {
        'name': '임실',
        'districts': [
    ...
    'gochang': {
        ...
        'description': '고인돌 유적지가 있는 역사 문화 지역입니다.'
    },
    'buan': {
        'name': '부안',
        'districts': [
        ...
        'description': '변산반도국립공원이 있는 해안 휴양지입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '문화 유적지',
        'spots': [
            '전주 한옥마을: 전통 한옥이 밀집된 마을로, 전통 문화를 체험할 수 있습니다.',
            '익산 미륵사지: 백제 시대의 대표적인 사찰 유적지입니다.',
            '고창 고인돌 유적지: 세계문화유산으로 지정된 고인돌 공원입니다.',
            '남원 광한루: 춘향전의 배경이 된 전통 누각입니다.'
        ]
    },
    {
        'category': '자연 관광지',
        'spots': [
            '내장산국립공원: 정읍에 있는 아름다운 산으로, 단풍이 유명합니다.',
            '덕유산국립공원: 무주와 장수에 걸쳐 있는 산으로, 스키장이 있습니다.',
            '마이산: 진안에 있는 독특한 형상의 산입니다.',
            '변산반도국립공원: 부안에 있는 해안 국립공원입니다.'
        ]
    },
    {
        'category': '쇼핑 및 엔터테인먼트',
        'spots': [
            '전주 전통시장: 전통 음식과 특산품을 구매할 수 있는 시장입니다.',
            '군산 근대역사박물관: 근대 문화유산을 감상할 수 있는 박물관입니다.',
            '전주 예술의전당: 다양한 공연과 전시를 즐길 수 있는 문화 공간입니다.',
            '무주 덕유산리조트: 스키와 골프를 즐길 수 있는 리조트입니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '전북 전통 음식',
        'foods': [
            '전주 비빔밥: 전북의 대표 음식으로, 전주 한옥마을에서 맛볼 수 있습니다.',
            '전주 콩나물국밥: 전주만의 특별한 콩나물국밥을 즐길 수 있습니다.',
            '순창 고추장: 순창에서 만든 전통 고추장을 맛볼 수 있습니다.',
            '임실 치즈: 임실에서 만든 유명한 치즈를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '전북 카페 및 디저트',
        'foods': [
            '전주 한옥마을 카페: 전통 한옥에서 즐기는 커피와 디저트입니다.',
            '전주 전통찻집: 전통 차와 한과를 즐길 수 있는 찻집입니다.',
            '전주 디저트 카페: 다양한 디저트와 브런치를 즐길 수 있는 카페입니다.',
            '전주 막걸리: 전주에서 만든 전통 막걸리를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '전북 맛집',
        'foods': [
            '전주 한정식 전문점: 전통 한정식을 맛볼 수 있는 전문점입니다.',
            '전주 회 전문점: 신선한 회와 해산물을 즐길 수 있습니다.',
            '전주 고기집: 전북의 유명한 고기집에서 맛있는 고기를 즐길 수 있습니다.',
            '전주 파스타 전문점: 다양한 파스타와 이탈리안 요리를 즐길 수 있습니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    ...
    region_description = region_info.get('description', '전북 지역')
    ...
    if theme_name:
        ...
        return f"""            <h3>{theme_info['icon']} {title_prefix} {theme_info['name']} 소개</h3>
            ...
            <p>
              {title_prefix} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '전북'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        if region_name == '전북':
            region_description = '전라북도의 중심 지역으로, 전통 문화와 현대가 어우러진 지역입니다.'
        return f"""            <h3>🌾 {title_prefix} 마사지 소개</h3>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {region_description} {display_name if display_name else '전북'}에서 제공되는 전문 마사지 서비스입니다. {display_name if display_name else '전북'}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              {title_prefix} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '전북'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ {title_prefix} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>는 {display_name if display_name else '전북'}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '전북'}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ {title_prefix} 마사지의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {display_name if display_name else '전북'}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '전북'}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    ...
    if region_name == '전북':
        # 전북 전체인 경우 시군 정보 제공
        districts = ['전주', '군산', '익산', '정읍', '남원', '김제', '완주', '진안', '무주', '장수', '임실', '순창', '고창', '부안']
        districts_html = '\n'.join([f'                <li><strong>{district}:</strong> 전북 {district}에는 전문 마사지 업체들이 위치해 있으며, 각 지역별로 특색 있는 마사지 서비스를 제공합니다.</li>' for district in districts[:10]])
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 전북 {theme_display} 추천 행정구간</h4>
            <p>
              <strong>전북</strong>은 다양한 시군으로 구성되어 있으며, 각 지역마다 전문 {theme_display} 업체들이 운영되고 있습니다. 전북의 주요 시군별 {theme_display} 특색을 소개합니다.
            </p>
            <div class="info-highlight">
              <h4>🏛️ 전북 주요 시군</h4>
              <ul>
{districts_html}
        ...
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 전북 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
def generate_tourism(region_name, theme_name=None):
    """관광 및 놀이 생성"""
    display_name = '전북' if region_name == '전북' else region_name
    title_prefix = '전북' if region_name == '전북' else f'전북 {region_name}'
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🎨 {title_prefix} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 전북의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 전북의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
{tourism_html.rstrip()}"""
        ...
        return f"""            <h4>🎨 {title_prefix} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 전북의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 전북의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🍽️ {title_prefix} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 전북의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 전북의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
{food_html.rstrip()}"""
        ...
        return f"""            <h4>🍽️ {title_prefix} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 전북의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 전북의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 {title_prefix} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']} 업체</strong>에서는 {display_name if display_name else '전북'}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 {title_prefix} 마사지 서비스 소개</h4>
            <p>
              <strong>{title_prefix} 마사지 업체</strong>에서는 {display_name if display_name else '전북'}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
...
def main():
    ...
    # 상세지역 파일들 (테마 없음)
    detail_regions = ['jeonju', 'gunsan', 'iksan', 'jeongeup', 'namwon', 'gimje', 
    ...
    # 1. 전북 전체 파일 업데이트
    print("=== 전북 전체 파일 업데이트 시작 ===")
    file_path = public_dir / 'jeonbuk.html'
    if file_path.exists():
        if update_file(file_path, '전북', None):
            updated_count += 1
    
    # 2. 전북 + 필터테마 파일들 업데이트
    print("\n=== 전북 + 필터테마 파일 업데이트 시작 ===")
    for theme in themes:
        file_path = public_dir / f'jeonbuk-{theme}.html'
        if file_path.exists():
            if update_file(file_path, '전북', theme):
                updated_count += 1
    
    # 3. 전북 + 상세지역 파일들 업데이트
    print("\n=== 전북 + 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'jeonbuk-{region}.html'
        if file_path.exists():
            region_name = region_name_map.get(region, region)
            if update_file(file_path, region_name, None):
                updated_count += 1
    
    # 4. 전북 + 상세지역 + 테마 파일들 업데이트
    print("\n=== 전북 + 상세지역 + 테마 파일 업데이트 시작 ===")
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'jeonbuk-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
