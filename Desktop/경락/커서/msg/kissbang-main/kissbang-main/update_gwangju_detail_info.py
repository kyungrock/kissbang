...
# -*- coding: utf-8 -*-
"""
광주 HTML 파일들의 관련정보 모달 내용을 자동으로 업데이트하는 스크립트
"""
...
REGION_DISTRICTS = {
    'donggu': {
        'name': '동구',
        'districts': [
            '시내 중심', '충장로', '서석동', '지산동', '용산동', '학동', '계림동'
        ],
        'description': '광주의 동쪽 지역으로, 충장로와 전통시장이 있는 상업 중심지입니다.'
    },
    'seogu': {
        'name': '서구',
        'districts': [
            '시내 중심', '치평동', '풍암동', '상무동', '화정동', '금호동', '매월동'
        ],
        'description': '광주의 서쪽 지역으로, 신도시와 주거지역이 발달한 지역입니다.'
    },
    'namgu': {
        'name': '남구',
        'districts': [
            '시내 중심', '봉선동', '주월동', '월산동', '방림동', '송하동', '양림동'
        ],
        'description': '광주의 남쪽 지역으로, 대학가와 문화 공간이 많은 지역입니다.'
    },
    'bukgu': {
        'name': '북구',
        'districts': [
            '시내 중심', '용봉동', '운암동', '두암동', '매곡동', '오룡동', '일곡동'
        ],
        'description': '광주의 북쪽 지역으로, 주거지역과 상업지역이 어우러진 지역입니다.'
    },
    'gwangsan': {
        'name': '광산',
        'districts': [
            '시내 중심', '수완동', '신가동', '운남동', '하남동', '평동', '도산동'
        ],
        'description': '광주의 광산구로, 신도시와 산업단지가 있는 지역입니다.'
    },
}
...
TOURISM_SPOTS = [
    {
        'category': '문화 유적지',
        'spots': [
            '광주 국립아시아문화전당: 아시아 문화를 체험할 수 있는 대형 문화 공간입니다.',
            '광주 비엔날레: 2년마다 열리는 국제 현대미술 전시회입니다.',
            '무등산국립공원: 광주의 대표 산으로, 등산과 자연 감상을 즐길 수 있습니다.',
            '광주 예술의전당: 다양한 공연과 전시를 즐길 수 있는 문화 공간입니다.'
        ]
    },
    {
        'category': '자연 관광지',
        'spots': [
            '무등산: 광주의 대표 산으로, 등산로와 전망대가 잘 조성되어 있습니다.',
            '광주호: 도심 속 호수로, 산책로와 자전거 도로가 있습니다.',
            '광주천: 도심을 흐르는 강으로, 강변 산책로가 잘 조성되어 있습니다.',
            '광주 수목원: 다양한 식물을 감상할 수 있는 수목원입니다.'
        ]
    },
    {
        'category': '쇼핑 및 엔터테인먼트',
        'spots': [
            '충장로: 광주의 대표 상업지역으로, 쇼핑과 식사를 즐길 수 있습니다.',
            '광주 CGV: 최신 영화를 감상할 수 있는 멀티플렉스입니다.',
            '광주 롯데시네마: 다양한 영화와 이벤트를 즐길 수 있는 영화관입니다.',
            '광주 대형마트: 생활용품과 식품을 구매할 수 있는 대형마트입니다.'
        ]
    }
]
...
FOOD_RECOMMENDATIONS = [
    {
        'category': '광주 전통 음식',
        'foods': [
            '광주 오리탕: 광주의 대표 음식으로, 시원한 국물이 일품입니다.',
            '광주 무등산 보리밥: 무등산에서 나는 보리로 만든 보리밥입니다.',
            '광주 떡볶이: 광주만의 특별한 떡볶이 맛을 즐길 수 있습니다.',
            '광주 순대: 전통 방식으로 만든 순대를 맛볼 수 있습니다.'
        ]
    },
    {
        'category': '광주 카페 및 디저트',
        'foods': [
            '광주 충장로 카페 거리: 다양한 카페에서 커피와 디저트를 즐길 수 있습니다.',
            '광주 대학가 카페: 대학가 근처의 트렌디한 카페들을 즐길 수 있습니다.',
            '광주 전통찻집: 전통 차와 한과를 즐길 수 있는 찻집입니다.',
            '광주 디저트 카페: 다양한 디저트와 브런치를 즐길 수 있는 카페입니다.'
        ]
    },
    {
        'category': '광주 맛집',
        'foods': [
            '광주 한정식 전문점: 전통 한정식을 맛볼 수 있는 전문점입니다.',
            '광주 회 전문점: 신선한 회와 해산물을 즐길 수 있습니다.',
            '광주 고기집: 광주의 유명한 고기집에서 맛있는 고기를 즐길 수 있습니다.',
            '광주 파스타 전문점: 다양한 파스타와 이탈리안 요리를 즐길 수 있습니다.'
        ]
    }
]
...
def generate_introduction(region_name, theme_name=None):
    """소개글 생성"""
    if region_name == '광주':
        region_description = '호남권의 중심 도시로, 문화와 예술이 살아있는 지역입니다.'
        display_name = ''
        title_prefix = '광주'
    else:
        region_key = {
            '동구': 'donggu', '서구': 'seogu', '남구': 'namgu', 
            '북구': 'bukgu', '광산': 'gwangsan'
        }.get(region_name, '')
        region_info = REGION_DISTRICTS.get(region_key, {})
        region_description = region_info.get('description', '광주 지역')
        display_name = region_name
        title_prefix = f'광주 {region_name}'
    ...
    if theme_name:
        ...
        return f"""            <h3>{theme_info['icon']} {title_prefix} {theme_info['name']} 소개</h3>
            ...
            <p>
              {title_prefix} {theme_info['name']}는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 {theme_info['name']} 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '광주'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
    else:
        return f"""            <h3>🎨 {title_prefix} 마사지 소개</h3>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {region_description} {display_name if display_name else '광주'}에서 제공되는 전문 마사지 서비스입니다. {display_name if display_name else '광주'}은 다양한 지역에 마사지 업체들이 위치해 있습니다.
            </p>
            <p>
              {title_prefix} 마사지는 단순한 피로 회복을 넘어서 몸과 마음의 완전한 힐링을 추구합니다. 전문 관리사들이 제공하는 다양한 마사지 기법을 통해 일상의 스트레스와 피로를 완전히 해소하고, {display_name if display_name else '광주'}의 여유로운 분위기 속에서 진정한 휴식을 경험할 수 있습니다.
            </p>"""
...
def generate_features(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>✨ {title_prefix} {theme_info['name']}의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>는 {display_name if display_name else '광주'}만의 독특한 특성을 가지고 있습니다. 전문 {theme_info['name']} 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '광주'}의 지역적 특색과 {theme_info['name']}의 전문성이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
...
{features_html}
        ...
        return f"""            <h4>✨ {title_prefix} 마사지의 특징과 내용</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>는 {display_name if display_name else '광주'}만의 독특한 특성을 가지고 있습니다. 다양한 마사지 서비스를 제공하며, 고객의 만족도를 최우선으로 생각합니다. {display_name if display_name else '광주'}의 지역적 특색과 전문 마사지 기술이 결합되어 최고의 힐링 경험을 선사합니다.
            </p>
            <div class="info-highlight">
              <h4>🌟 마사지의 핵심 특징</h4>
              <ul>
...
def generate_districts(region_name, theme_name=None):
    ...
    if region_name == '광주':
        ...
        districts_html = '\n'.join([f'                <li><strong>{district}:</strong> 광주 {district}에는 전문 마사지 업체들이 위치해 있으며, 각 구별로 특색 있는 마사지 서비스를 제공합니다.</li>' for district in districts])
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 광주 {theme_display} 추천 행정구간</h4>
            <p>
              <strong>광주</strong>은 5개 구로 구성되어 있으며, 각 구마다 전문 {theme_display} 업체들이 운영되고 있습니다. 광주의 주요 구별 {theme_display} 특색을 소개합니다.
            </p>
            <div class="info-highlight">
              <h4>🏛️ 광주 주요 구</h4>
              <ul>
{districts_html}
        ...
        theme_display = THEME_INFO[theme_name]['name'] if theme_name and theme_name in THEME_INFO else "마사지"
        return f"""            <h4>🗺️ 광주 {region_name} {theme_display} 추천 행정구간</h4>
            <p>
...
def generate_tourism(region_name, theme_name=None):
    """관광 및 놀이 생성"""
    display_name = '광주' if region_name == '광주' else region_name
    title_prefix = '광주' if region_name == '광주' else f'광주 {region_name}'
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🎨 {title_prefix} {theme_info['name']} 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 광주의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. {theme_info['name']}로 풀린 몸과 마음으로 광주의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
{tourism_html.rstrip()}"""
        ...
        return f"""            <h4>🎨 {title_prefix} 마사지 후 추천 관광지 및 놀이</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 광주의 다양한 관광지와 놀이 시설을 즐기실 수 있습니다. 마사지로 풀린 몸과 마음으로 광주의 특별한 경험을 더욱 풍성하게 만들어보세요.
            </p>
...
"""
    ...
    if theme_name:
        ...
        return f"""            <h4>🍽️ {title_prefix} {theme_info['name']} 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']}</strong>를 받은 후에는 광주의 맛있는 음식으로 에너지를 보충하세요. {theme_info['name']}로 활력을 회복한 후 광주의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
{food_html.rstrip()}"""
        ...
        return f"""            <h4>🍽️ {title_prefix} 마사지 후 추천 음식 및 경로</h4>
            <p>
              <strong>{title_prefix} 마사지</strong>를 받은 후에는 광주의 맛있는 음식으로 에너지를 보충하세요. 마사지로 활력을 회복한 후 광주의 특별한 맛을 즐기시면 더욱 완벽한 하루가 됩니다.
            </p>
...
def generate_services(region_name, theme_name=None):
    ...
    if theme_name:
        ...
        return f"""            <h4>🎁 {title_prefix} {theme_info['name']} 서비스 소개</h4>
            <p>
              <strong>{title_prefix} {theme_info['name']} 업체</strong>에서는 {display_name if display_name else '광주'}만의 특별한 {theme_info['name']} 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
...
{services_detail_html}
        ...
        return f"""            <h4>🎁 {title_prefix} 마사지 서비스 소개</h4>
            <p>
              <strong>{title_prefix} 마사지 업체</strong>에서는 {display_name if display_name else '광주'}만의 특별한 마사지 서비스와 상품을 제공하여 고객님들의 만족도를 극대화하고 있습니다.
            </p>
            <div class="service-categories">
...
def main():
    ...
    # 상세지역 목록
    detail_regions = ['donggu', 'seogu', 'namgu', 'bukgu', 'gwangsan']
    ...
    # 1. 광주 전체 파일 업데이트
    print("=== 광주 전체 파일 업데이트 시작 ===")
    file_path = public_dir / 'gwangju.html'
    if file_path.exists():
        if update_file(file_path, '광주', None):
            updated_count += 1
    
    # 2. 광주 + 필터테마 파일들 업데이트
    print("\n=== 광주 + 필터테마 파일 업데이트 시작 ===")
    for theme in themes:
        file_path = public_dir / f'gwangju-{theme}.html'
        if file_path.exists():
            if update_file(file_path, '광주', theme):
                updated_count += 1
    
    # 3. 광주 + 상세지역 파일들 업데이트
    print("\n=== 광주 + 상세지역 파일 업데이트 시작 ===")
    for region in detail_regions:
        file_path = public_dir / f'gwangju-{region}.html'
        if file_path.exists():
            region_name = region_name_map.get(region, region)
            if update_file(file_path, region_name, None):
                updated_count += 1
    
    # 4. 광주 + 상세지역 + 테마 파일들 업데이트
    print("\n=== 광주 + 상세지역 + 테마 파일 업데이트 시작 ===")
    for region in detail_regions:
        for theme in themes:
            file_path = public_dir / f'gwangju-{region}-{theme}.html'
            if file_path.exists():
                region_name = region_name_map.get(region, region)
